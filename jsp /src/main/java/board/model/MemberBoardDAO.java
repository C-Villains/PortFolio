...
public class MemberBoardDAO {
	...
	// �Խ��� ��� ��ȸ ��� ����
	public ArrayList<MemberBoardDTO> MemberboardList(String curPage){
		...
		try{
			...
			while(rs.next()){
				...
				MemberBoardDTO writing = new MemberBoardDTO();
				writing.setNum(num);
	...
	// �Խñ� ��� ��� ����
	public void MemberboardWrite(String name, String subject, String content, String password){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int num = 1;
	...
	// �Խñ� ���� ��� ����	
	public MemberBoardDTO MemberboardRead(String inputNum){
	...
	// �� ���� ȭ�鿡 �ʿ��� ���� ������ ��ȸ ���
	public MemberBoardDTO MemberboardUpdateForm(String inputNum){
	...
	public void MemberboardDelete(String inputNum){
		...
		try{
			...
			if(rs.next()){
				...
				MemberboardDeleteChildCntUpdate(ref, lev, step);
			}			
	...
	public void MemberboardReply(String num, String name, String subject, String content, String password, String ref, String step, String lev){
		...
		try{
			...
			replyStep = MemberboardReplySearchStep(ref, lev, step); // ����� ��ġ�� step ���� ������
			...
			pstmt.executeUpdate();
			MemberboardReplyChildCntUpdate(ref, lev, replyStep);
	...
	public ArrayList<MemberBoardDTO> MemberboardSearch(String searchOption, String searchWord) {
